...
#define HC_04_INDEX                  ( UART_3 )                      // HC-04 模块建议使用的串口号（可根据需要修改）
#define HC_04_BAUD_RATE              ( 9600 )                        // HC-04 模块默认波特率（9600/38400/115200等，需与模块设置一致）
#define HC_04_TX_PIN                 ( UART3_TX_B10 )                // 单片机TX引脚，连接模块RX
#define HC_04_RX_PIN                 ( UART3_RX_B11 )                // 单片机RX引脚，连接模块TX
